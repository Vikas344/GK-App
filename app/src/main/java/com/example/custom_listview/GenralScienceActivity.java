...
public class GenralScienceActivity extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_genral_science);

        listView=(ListView) findViewById(R.id.listviewforgeneralscience);
